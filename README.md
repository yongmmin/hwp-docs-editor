...
4. **내보내기** — 헤더 `내보내기` 버튼 → 편집 내용이 반영된 `.hwp` / `.hwpx` 다운로드 (원본 포맷 유지)

   > ⚠️ 내보내기 기능은 현재 원본 보존율 향상을 위해 전면 재작성 진행 중입니다.
   > 상세 계획: [docs/EXPORT_REWRITE_PLAN.md](docs/EXPORT_REWRITE_PLAN.md)
